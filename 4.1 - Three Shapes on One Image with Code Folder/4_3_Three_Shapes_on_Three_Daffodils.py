...
# Display an Image.
cv2.imshow('Daffodils Covered by a Solid Circle, a Clear Circle, and a Bounding Box',img)
...
if k == 27:         # Wait for ESC key to exit.
    ...
    cv2.imwrite('Daffodils Covered by a Solid Circle, a Clear Circle, and a Bounding Box.png',img)
